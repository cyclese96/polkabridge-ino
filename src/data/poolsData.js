...
let pool6 = {
  ...
  title: "Aethereal Parcels",
  type: "Packages",
  totalPackages: "1",
  description: `Tatsumeeko is an MMORPG-lite that connects Discord and mobile communities to a modern fantasy RPG world, invested by Binance Labs.`,
  ...
  utilities: [
    ...
    "Players who own parcels will receive all the tiles/objects within the parcels, which they can use to decorate #Tatsumeeko personal dimensions.",
